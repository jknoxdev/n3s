...
summaries_folder = r'C:\Users\Administrator\Desktop\jpeg-design\reports\scripts\summaries'
status_folder = r'C:\Users\Administrator\Desktop\jpeg-design\reports\scripts\status'

summaries_files = [f for f in os.listdir(summaries_folder) if f.endswith(".pdf")]
status_files = [f for f in os.listdir(status_folder) if f.endswith(".pdf")]
